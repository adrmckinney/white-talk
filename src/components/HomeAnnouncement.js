    ...
    <div className='bg-darkBlueGray'>
      <div className='max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between'>
        <h2 className='text-3xl font-extrabold tracking-tight text-gray-800 sm:text-4xl space-y-12'>
          ...
          <span className='block text-snow text-center font-bold'>Join us May 23rd at 4pm for a session to discuss our successes and struggles as we try to live life with our anti-racist values.</span>
        </h2>
