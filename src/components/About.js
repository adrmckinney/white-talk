...
const About = () => {
  ...
  console.log('facilitatorIndex', facilitatorIndex)
  console.log('FACILITATORS_LENGTH', FACILITATORS_LENGTH)
                ...
                <div className='mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start space-x-2'>
                  {FACILITATORS_LENGTH > 2 &&
                    <div className='rounded-md shadow'>
                      <button
                        className='w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-darkerPurple bg-indigo-100 hover:bg-indigo-200 md:py-4 md:text-md md:px-10'
                  ...
                  <div className='rounded-md shadow'>
                    <button
                      className='w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-darkerPurple bg-indigo-100 hover:bg-indigo-200 md:py-4 md:text-lg md:px-10'
                      onClick={() => {
                        increaseIndexCount()
                      }}
                    >
