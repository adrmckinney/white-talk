        ...
        <div className='space-y-12 lg:grid lg:grid-cols-3 lg:gap-8 lg:space-y-0'>
          <div className='space-y-5 sm:space-y-4'>
            ...
            <p className='text-xl text-gray-500'>
              The facilitators who White Talk have been active in the Durham community for many
              years. Get to know us.
            </p>
          </div>
                ...
                <li key={facilitator.name} className='sm:py-8'>
                  <div className='space-y-4 sm:grid sm:grid-cols-3 sm:items-start sm:gap-6 sm:space-y-0'>
                    <div className='aspect-w-3 aspect-h-2 sm:aspect-w-3 sm:aspect-h-4'>
                      <img
                        className={`${
                          facilitator.imageUrl === natalieBike ? 'object-top' : 'object-center'
                        } object-cover shadow-lg rounded-lg`}
                        src={facilitator.imageUrl}
                        alt={facilitator.caption}
                      />
                    </div>
