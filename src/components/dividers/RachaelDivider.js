...
const RachaelDivider = () => {
  return (
    <>
      <div className='z-50 mx-auto pt-20 px-4 sm:px-6 lg:px-8 h-full w-full bg-davysGray parallax' aria-hidden='true'>
        <blockquote className='mt-10 font-nunito'>
          <footer className='my-8'>
            <div className='md:flex md:items-center md:justify-center'>
              <div className='mt-3 text-center md:mt-0 md:ml-4 md:flex md:items-center'>
                <div className='text-3xl font-medium text-babyBlueEyes'>{MESSAGES.title}</div>
              </div>
            </div>
          </footer>
          <div className='max-w-5xl mx-auto text-center text-xl leading-9 font-medium text-snow'>
            <div>
              &ldquo;{MESSAGES.paragraph1}&rdquo;
            </div>
          </div>
          <div className='max-w-5xl mx-auto text-center text-xl leading-9 font-medium text-snow pt-16'>
            <div>
