          ...
          <footer className='mt-8'>
            <div className='md:flex md:items-center md:justify-center'>
              <div className='mt-3 text-center md:mt-0 md:ml-4 md:flex md:items-center'>
                <div className='text-base font-medium text-snow'>Heather Hackman</div>

                <svg className='hidden md:block mx-1 h-5 w-5 text-darkerPurple' fill='currentColor' viewBox='0 0 20 20'>
                  <path d='M11 0h3L9 20H6l5-20z' />
                </svg>

                <div className='text-base italic font-medium text-snow'>Everyday White People Confront Racial and Social Injustice, <span className='not-italic'>60</span></div>
              </div>
            </div>
          </footer>
        </blockquote>
...
export default HeatherHackmanDivider
