...
export default function LoginOverlay ({ showModal, setShowModal, setAuth, setIsSigningIn, filterLogin, setFilterLogin, isLoading, setIsLoading, errors, setErrors, showOverlay, setShowOverlay }) {
      ...
      <div className='absolute inset-0 overflow-hidden'>
        <section className='absolute inset-y-0 right-0 pl-10 max-w-full flex sm:pl-16' aria-labelledby='slide-over-heading'>
          ...
          >
            ...
            <div className='w-screen max-w-md h-screen pr-8'>
              <div className='h-full flex flex-col bg-white shadow-xl overflow-y-scroll'>
                <div className='py-6 px-4 bg-mediumPurple sm:px-6'>
                  <div className='flex items-center justify-between'>
                    ...
                    <h1 className='text-lg font-medium text-white'>Admin Login</h1>
