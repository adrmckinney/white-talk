...
import { ChevronDoubleLeftOutline } from '@graywolfai/react-heroicons'

export default function EmailConfirmation ({ handleCloseConfirmationModal }) {
          ...
          >
            <div className='inline-block align-bottom bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6'>
                ...
                <div className='mt-3 text-center sm:mt-5'>
                  ...
                  <div className='mt-2'>
                    <p className='text-sm text-gray-500'>
                      Thank you for reaching out. Rachael will respond to your email as soon as she is able.
                    </p>
                  </div>
                </div>
              </div>
              <div className='mt-5 sm:mt-6'>
                ...
                >
                  <ChevronDoubleLeftOutline className='h-4 w-4 mr-4 self-center' />
                  Go back
                </button>
              </div>
            </div>
