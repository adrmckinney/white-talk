...
import { withAnnouncementsState } from './announcements/withAnnouncementsState'
            ...
            <main className='mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28'>
              <div className='text-center lg:text-left'>
                <h1 className='flex flex-col text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl space-y-2 lg:space-y-0 pt-10 sm:pt-4 lg:pt-0'>
                  ...
                  <span className='block text-mediumPurple xl:inline uppercase font-playFair'>
                    Racial Equity <span className='lowercase'>white</span> Talk
                  </span>
                </h1>
                <p className='mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0 font-nunito'>
                  We invite you to join us as we explore white identity in the context of racism in
                  the US. Through book studies and weekly sessions we explore what it means to live
                  an anti-racist life and to do anti-racist work as white people. We do this in a
                  community of white people, all learning, all leaning into discomfort, all making
                  mistakes, and all growing in this work.
                </p>
              </div>
            </main>
          </div>
...
export default withAnnouncementsState(Home)
